    ...
    while ($fila = $bd->mostrar_registros()) {
        ...
        <div class="col-md-10">
            <div class="box box-primary">
                ...
                <form role="form" name="fe" action="?mod=registro&actualizar&codigo=<?php echo $fila['id_usuarios']; ?>" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputFile">Nombre</label>
        ...
        <div class="col-md-10">
            <div class="box box-danger">
                ...
                <div class="box-body">
                    ...
                    <form action="?mod=registro&confirmar_eliminar&codigo=<?php echo $fila['id_usuarios']; ?>" method="post">
...
// Manejo de la consulta de usuarios
if (isset($_GET['consultar'])) { 
    $codigo = $_GET['codigo'];
    $consulta = "SELECT * FROM usuarios WHERE id_usuarios='$codigo'";
    $bd->consulta($consulta);
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <p><?php echo $fila['correo']; ?></p>
                        <label>Teléfono:</label>
                        <input onkeydown="return enteros(this, event)" required type="text" name="telefono" class="form-control" placeholder="Teléfono" value="<?php echo $fila['telefono']; ?>">
                        <label>Dirección:</label>
                        <input required type="text" name="direccion" class="form-control" placeholder="Dirección" value="<?php echo $fila['direccion']; ?>">
